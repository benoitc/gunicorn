...
class KeyFile(Setting):
    ...
    desc = """\
        For SSL: path to a PEM format private key file.
        """
...
class CertFile(Setting):
    ...
    validator = ssl_validate_string(default)
    desc = """\
        For SSL: path to a PEM format certificate file.
...
class CertReqs(Setting):
    ...
    default = 0
    desc = """\
        For SSL: 0=CERT_NONE, 1=CERT_OPTIONAL, 2=CERT_REQUIRED
        """
...
class SSLVersion(Setting):
    ...
    desc = """\
        For SSL: 0=SSLv2, 1=SSLv3, 2=SSLv23, 3=TLSv1
        """
...
class CACerts(Setting):
    ...
    validator = ssl_validate_string(default)
    desc = """\
        For SSL: path to a PEM format CA certs file.
        """
